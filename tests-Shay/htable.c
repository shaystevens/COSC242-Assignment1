 ...
 *
 * @param capacity of the htable.
 * @param hashing_type solution to collisions (linear probing/ double hashing).
 *
 ...
 *
 * @param h a hash table.
 * @param *str string to be inserted into string.
 *
 * @return returns int 1 if NULL, key frequency, or 0 if hash table is full.
 */
...
/**
 * Searchs the hash table to find if str is inside the hash table h.
 *
 * @param h the hash table.
 * @param *str the string to be found.
 *
 * @return returns int, str frequency if str is in hash table, or 0 if not.
 */
...
/**
 * Prints the entire hash table, position frequency, collosion stats, and word.
 *
 * @param h the hash table.
 * @param *stream location where the table will be printed.
 */
